...
export class ServiceBulletinsController {
  constructor(private readonly serviceBulletinsService: ServiceBulletinsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateServiceBulletinDto: UpdateServiceBulletinDto) {
